...
export function RegisterStepOneForm() {
    ...
    return (<View style={styles.container}>
            ...
            return (<Input inputContainerStyle={styles.inputContainer} iconLeft={<ICONS.MailIcon />} label="Email" placeholder="email@gmail.com" onChangeText={field.onChange} value={field.value} error={fieldState.error?.message}/>);
        }}/>
                <Controller name="username" control={control} render={({ field, fieldState }) => {
            return (<Input inputContainerStyle={styles.inputContainer} iconLeft={<ICONS.UserIcon />} label="Username" placeholder="User123" onChangeText={field.onChange} value={field.value} error={fieldState.error?.message}/>);
        }}/>
                <Controller name="password" control={control} render={({ field, fieldState }) => {
            return (<Input.Password onChangeText={field.onChange} value={field.value} error={fieldState.error?.message}/>);
        }}/>
            </View>
