...
import { useRegisterMutation } from "@modules/auth/api/userApi";
...
export function RegisterStepTwoForm() {
    ...
    return (<View style={styles.container}>
            <View style={styles.formFields}>
                <Controller name="name" control={control} render={({ field, fieldState }) => (<Input inputContainerStyle={styles.inputContainer} placeholder="Name" onChangeText={field.onChange} value={field.value} error={fieldState.error?.message}/>)}/>

                <Controller name="surname" control={control} render={({ field, fieldState }) => (<Input inputContainerStyle={styles.inputContainer} placeholder="Surname" onChangeText={field.onChange} value={field.value} error={fieldState.error?.message}/>)}/>

                <View style={styles.avatarContainer}>
                    <Controller name="avatar" control={control} render={({ field }) => (<AvatarField value={field.value} onChange={field.onChange}/>)}/>
                </View>
            </View>
